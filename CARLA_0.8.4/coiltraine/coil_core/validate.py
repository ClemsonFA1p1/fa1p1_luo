...
def execute(gpu, exp_batch, exp_alias, dataset_name, suppress_output):
    ...
    try:
            ...
            if is_next_checkpoint_ready(g_conf.TEST_SCHEDULE):
                ...
                for data in data_loader:
                    ...
                    if g_conf.USE_MOCO:
                      ...
                      representation = moco_model.moco.generate_representation(data['rgb'].cuda())
                      
                      output = model.forward_branch(representation,
                ...
                if g_conf.FINISH_ON_VALIDATION_STALE is not None:
                    if dlib.count_steps_without_decrease(l1_window) > 20 and \
        ...
        ax.plot(checkpoints, l1_window)
        ax.set(xlabel='Checkpoint', ylabel='Loss', title='Validation loss')
        ax.grid()
