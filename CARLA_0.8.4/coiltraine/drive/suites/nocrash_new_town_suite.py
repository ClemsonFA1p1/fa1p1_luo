...
class NocrashNewTown(ExperimentSuite):
    ...
    def build_experiments(self):
        ...
        if not g_conf.IMAGE_TRANSLATION:
          ...
          left_camera = Camera('rgb')
          left_camera.set(FOV=100)
          left_camera.set_image_size(800, 600)
          left_camera.set_position(2.0, -1.3, 1.4)
          left_camera.set_rotation(-15.0, -15.0, 0)
        ...
        for weather in self.weathers:
            ...
            for iteration in range(len(poses_tasks)):
                ...
                if g_conf.IMAGE_TRANSLATION:
                  conditions.add_sensor(left_camera)
                else:
